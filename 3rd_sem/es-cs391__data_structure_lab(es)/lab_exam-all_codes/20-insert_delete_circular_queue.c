//20. Write a C program to implement insertion and deletion operation in a circular queue (using function functions and switch case and represent queue using array )
